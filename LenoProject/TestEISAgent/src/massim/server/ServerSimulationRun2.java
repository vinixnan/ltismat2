...
//			Necessary for the monitor :-( FIXME
			...
			if(!xmlconfiguration.getAttribute("rmixmlobserver").equals(""))
			{
			...
			if(!xmlconfiguration.getAttribute("rmixmlobserverweb").equals(""))
			{
			...
			// create XML observer
			if(!xmlconfiguration.getAttribute("xmlobserver").equals(""))
			{
			...
			if(!xmlconfiguration.getAttribute("xmlstatisticsobserver").equals("")){
...
//			}
			...
			// create visualisation observer
			if(!xmlconfiguration.getAttribute("visualisationobserver").equals("")) {
