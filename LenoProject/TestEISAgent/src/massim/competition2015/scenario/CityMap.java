...
import massim.competition2015.scenario.routing.GraphHopperManager;
...
/**
 * The class that will implement the CityMap in the future.
 * 
 * @author fschlesinger
 *
 */
	...
	private Route getNewCarRoute(Location from, Location to){
		...
		if(rsp.hasErrors()) {
			...
			for (Throwable t: rsp.getErrors()){
				...
				log(LOGLEVEL_ERROR, "CityMap: No route found: " + t.getLocalizedMessage());
				//t.printStackTrace();
			}
		   return null;
		}
